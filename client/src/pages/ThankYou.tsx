    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="h-[30vh] sm:h-[35vh] md:h-[40vh] w-full relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center flex-col px-4 space-y-2 sm:space-y-4">
          {/* Logo en burbuja glassmorphism con sombras mejoradas */}
            <div className="mb-6 sm:mb-8">
              <div className="glass-card w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-full p-3 sm:p-4 flex items-center justify-center
                            shadow-2xl drop-shadow-lg transform transition-all duration-300 hover:scale-105">
                <img 
